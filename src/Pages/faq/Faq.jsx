...
const Faq = () => {
    ...
    return (
        <div className="lg:w-1/2 w-[95%] mx-auto my-10">
            <h1 className="text-center text-3xl md:text-5xl mb-4 lg:mb-8" style={{ fontWeight: '700' }} data-aos='fade-down'>Frequently asked questions?</h1>
            <p className="text-center mb-8 text-base md:text-xl" data-aos='fade-up'>Are you unsure of how Synkify platform works? We’ve have answers for you here</p>
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />} data-aos='fade-up' data-aos-delay='600' data-aos-duration='900'>
                <AccordionHeader className="text-base md:text-xl text-left" onClick={() => handleOpen(1)}>
                    How does Synkify platform works?
                </AccordionHeader>
                <AccordionBody className="text-base md:text-xl">
            ...
            <Accordion open={open === 2} icon={<Icon id={2} open={open} />} data-aos='fade-up' data-aos-delay='900' data-aos-duration='900'>
                <AccordionHeader className="text-base md:text-xl text-left" onClick={() => handleOpen(2)}>
            ...
            <Accordion open={open === 3} icon={<Icon id={3} open={open} />} data-aos='fade-up' data-aos-delay='1200' data-aos-duration='900'>
                <AccordionHeader className="text-base md:text-xl text-left" onClick={() => handleOpen(3)}>
            ...
            <Accordion open={open === 4} icon={<Icon id={4} open={open} />} data-aos='fade-up' data-aos-delay='1500' data-aos-duration='900'>
                <AccordionHeader className="text-base md:text-xl text-left" onClick={() => handleOpen(4)}>
            ...
            <Accordion open={open === 5} icon={<Icon id={5} open={open} />} data-aos='fade-up' data-aos-delay='1800' data-aos-duration='900'>
                <AccordionHeader className="text-base md:text-xl text-left" onClick={() => handleOpen(5)}>
            ...
            <Accordion open={open === 6} icon={<Icon id={6} open={open} />} data-aos='fade-up' data-aos-delay='2100' data-aos-duration='900'>
                <AccordionHeader className="text-base md:text-xl text-left" onClick={() => handleOpen(6)}>
            ...
            <div className="flex flex-col items-center my-10" data-aos='zoom-in-down'>
                <h3 className="text-center text-2xl mb-4 lg:mb-8" style={{ fontWeight: '700' }}>You didn’t find an answer to your question here?</h3>
                <h4 className="text-center mb-8 text-base md:text-xl">Kindly, reach out to our support team here for further answers </h4>
